...
![5 surgery ASPE formulation](Figures\Homework3\p3a.PNG){height=50%}

![5 surgery ASPE model set up](Figures\Homework3\modelp3a.PNG){height=50%}
...
![10 surgery degenerative schedule](Figures\Homework3\p3bsnW.PNG){height=50%}


When $X_{51} = 0$ constraint was added to the model, then a plausible schedule resulted.

![10 surgery ASPE formulation](Figures\Homework3\p3b.PNG){height=50%}

![10 surgery ASPE model set up](Figures\Homework3\modelp3b.PNG){height=50%}
...
![Lumberyard ASPE Model setup](Figures\Homework3\pEC.PNG){height=50%}

![Lumberyard ASPE Model constraints](Figures\Homework3\modelpEC.PNG){height=40%}
